...
class WaveRiderStrategy(Strategy):
    ...
    volume_threshold = 2    # [1.5, 2.0, 2.5] - Reduced to catch more waves
    momentum_length = 5       # [5, 10, 15]
    ...
    min_volume_increase = 1.9  # [1.3, 1.5, 1.8] - Reduced to catch more waves
    rsi_length = 20            # [10, 14, 20]
...
def main():
    ...
    optimization_params = {
        ...
        # 'risk_per_trade': [0.005, 0.01, 0.02,0.05,0.1],
        # 'min_volume_increase': [1.85,1.9,1.95],
        # 'rsi_length': [18,20,22],
        # 'rsi_overbought': [70, 75, 80],
        # 'rsi_oversold': [15,18,20],
